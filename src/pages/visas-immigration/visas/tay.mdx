...
const { base } = Astro.config

<div class="flex flex-row mb-4 items-center">
    <div class="h-40 mr-4"><img class="max-h-full" src="/src/img/flags/tay.png" alt="Flag of TAY" /></div>
    # TAY
</div>
...
- A path to citizenship. To become a citizenship of Anatoli, you must [apply as a permanent resident](/visas-immigration/immigration) and become naturalized in Anatoli.